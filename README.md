...
Suppose a time step has elapsed and we got another sensor reading, D3 = d3, but we are still interested in C2. Compute the posterior distribution P(C2 = c2 | D2 = d2,D3 = d3) by implementing get_conditional_prob2.
